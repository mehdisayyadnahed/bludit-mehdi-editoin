 ...
 */
    ...
    $tabs = array("pending" ,"approved" ,"rejected");
?>
<h2 class="mt-0 mb-3">
    <span class="oi oi-comment-square" style="font-size: 0.7em;"><?php sn_e("Comments"); ?></span>
</h2>
...
<ul class="nav nav-pills" data-handle="tabs">
    ...
    <!-- <li class="nav-item mr-2" style="margin-left: 5px; ">
        <a id="users-tab" href="#snicker-users" class="btn btn-primary" style="border-radius: 5px;" data-toggle="tab">
            <span class="oi oi-people"></span> <?php #sn_e("Users"); ?>
        </a>
    </li>
    <li class="nav-item">
        <a id="configure-tab" href="#snicker-configure" class="btn btn-primary" style="border-radius: 5px;" data-toggle="tab">
