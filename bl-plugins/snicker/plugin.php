...
##
        ...
        public function request(){
            ...
            if(!empty($key)){
                ...
                if (!in_array($login->role(), array('admin', 'editor', 'author'))){
                    return $this->response(array(
                    ...
                    ?>
                        <div id="dialog-deactivate-snicker" class="modal fade" role="dialog">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content" style="background-color: #121212; color: #839496;">
                                    ...
                                    <div class="modal-footer" style="background-color: #121212; color: #839496;">
                                        <button type="button" class="btn btn-primary" style="border-radius: 5px;" data-snicker="backup"><?php sn_e("Yes, create a Backup"); ?></button>
                                        <button type="button" class="btn btn-danger" style="border-radius: 5px;" data-snicker="deactivate"><?php sn_e("No, just Deactivate"); ?></button>
                                        <button type="button" class="btn btn-secondary" style="border-radius: 5px;" data-dismiss="modal"><?php sn_e("Cancel"); ?></button>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        public function adminSidebar(){
            ...
            ?>
                <a href="<?php echo HTML_PATH_ADMIN_ROOT; ?>snicker" class="nav-link" style="white-space: nowrap;">
                    <span class="oi oi-comment-square"><?php sn_e("Comments"); ?></span>
                    <?php if(!empty($count)){ ?>
