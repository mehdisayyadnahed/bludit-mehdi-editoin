/*! Select2 4.0.13 | https://instagram.com/select2/select2/blob/master/LICENSE.md */ ! function(n) {
            ...
            return e && e.requirejs || (e ? n = e : e = {}, m = {}, v = {}, y = {}, _ = {}, r = Object.prototype.hasOwnProperty, a = [].slice, w = /\.js$/, f = function(e, t) {
                ...
                return {
                    errorLoading: function() {
                        return "نتایج نمی توانند بارگذاری شوند."
                    },
                    inputTooLong: function(e) {
                        var t = e.input.length - e.maximum,
                            n = "لطفا " + t + " کاراکتر را حذف کنید";
                        return 1 != t && (n += "s"), n
                    },
                    inputTooShort: function(e) {
                        return "لطفا " + (e.minimum - e.input.length) + " کاراکتر و یا بیشتر وارد کنید"
                    },
                    loadingMore: function() {
                        return "بارگذاری نتایج بیشتر …"
                    },
                    maximumSelected: function(e) {
                        var t = "شما فقط می توانید " + e.maximum + " آیتم انتخاب کنید";
