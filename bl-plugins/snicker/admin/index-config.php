...
<div id="snicker-configure" class="tab-pane">
    <form method="post" style="margin-bottom: 3rem;" action="<?php echo HTML_PATH_ADMIN_ROOT; ?>snicker#configure">
    <div style="padding: 1rem 0 1rem; display: flex; justify-content: left;">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                ...
                                <div class="custom-control custom-checkbox pl-5 mt-1">
                                    ...
                                    <label class="custom-control-label" for="sn-moderation-loggedin"><span style="margin-right: 1.5rem;"><?php sn_e("Unless the user is logged in"); ?></span></label>
                                </div>
                                <div class="custom-control custom-checkbox pl-5">
                                    ...
                                    <label class="custom-control-label"><span style="margin-right: 1.5rem;"><?php sn_e("Unless the user is admin or the content author"); ?></span></label>
                                </div>
                                <div class="custom-control custom-checkbox pl-5 mb-2">
                                    ...
                                    <label class="custom-control-label" for="sn-moderation-approved"><span style="margin-right: 1.5rem;"><?php sn_e("Unless the user has an already approved comment"); ?></span></label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <div class="custom-control custom-checkbox">
                                    ...
                                    <label class="custom-control-label" for="sn-comment-on-public"><span style="margin-right: 1.5rem;"><?php sn_e("... on Public Pages"); ?></span></label>
                                </div>
                                <div class="custom-control custom-checkbox">
                                    ...
                                    <label class="custom-control-label" for="sn-comment-on-sticky"><span style="margin-right: 1.5rem;"><?php sn_e("... on Sticky Pages"); ?></span></label>
                                </div>
                                <div class="custom-control custom-checkbox">
                                    ...
                                    <label class="custom-control-label" for="sn-comment-on-static"><span style="margin-right: 1.5rem;"><?php sn_e("... on Static Pages"); ?></span></label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="number" id="sn-comment-limit" name="comment_limit" value="<?php echo sn_config("comment_limit"); ?>"
                                    class="form-control" min="0" max="99" step="1" placeholder="<?php sn_e("Use '0' to disable any limit!"); ?>" />
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="number" id="sn-comment-depth" name="comment_depth" value="<?php echo sn_config("comment_depth"); ?>"
                                    class="form-control" min="0" max="9" step="1" placeholder="<?php sn_e("Use '0' to disable any limit!"); ?>" />
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <div class="custom-control custom-checkbox">
                                    ...
                                    <label class="custom-control-label" for="sn-markup-html"><span style="margin-right: 1.5rem;"><?php sn_e("Allow Basic HTML"); ?></span></label>
                                </div>
                                <div class="custom-control custom-checkbox">
                                    ...
                                    <label class="custom-control-label" for="sn-markup-markdown"><span style="margin-right: 1.5rem;"><?php sn_e("Allow Markdown"); ?></span></label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                ...
                                <div class="custom-control custom-checkbox">
                                    ...
                                    <label class="custom-control-label" for="sn-like"><span style="margin-right: 1.5rem;"><?php sn_e("Allow to %s comments", array("<b>".sn__("Like")."</b>")); ?></span></label>
                                </div>
                                <div class="custom-control custom-checkbox">
                                    ...
                                    <label class="custom-control-label" for="sn-dislike"><span style="margin-right: 1.5rem;"><?php sn_e("Allow to %s comments", array("<b>".sn__("Dislike")."</b>")); ?></span></label>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="number" id="sn-per-page" name="frontend_per_page" value="<?php echo sn_config("frontend_per_page"); ?>"
                                    class="form-control" min="0" max="9" step="1" placheolder="<?php sn_e("Use '0' to show all available comments!"); ?>" />
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                ...
                                <div class="custom-control custom-checkbox mt-1">
                                    ...
                                    <label class="custom-control-label" for="sn-moderation-users"><span style="margin-right: 1.5rem;"><?php sn_e("Use & Prefer profile pictures on logged-in Users"); ?></span></label>
                                </div>
                            </div>
                        </div>
