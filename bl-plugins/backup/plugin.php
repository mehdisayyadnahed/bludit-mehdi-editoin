...
class pluginBackup extends Plugin {
	...
	public function adminSidebar()
	{
		...
		if ($login->role() === 'admin') {
			...
			return '<a class="nav-link" href="'.HTML_PATH_ADMIN_ROOT.'configure-plugin/'.$this->className().'"> <span class="badge badge-primary badge-pill">'.count($backups).'</span> فایل پشتیبان</a>';
		} else {
			return '';
		}
	}
