...
##
         ...
         */
        public function generateCaptcha($width = 150, $height = 43, $src = false){
...
##
        ...
        public function renderForm($username = "", $email = "", $title = "", $comment = ""){
            ...
            ?><div id="comments-form" class="snicker-comments-form"><?php
                if($this->commentsAllowed($page)){
                    ...
                    ?>
                        <div class="card card-body disabled-comments" style="background-color: #121212;">
        ...
        public function render($print = false){
            ...
            ob_start();
            ?>
                <hr style=" border: 1px solid #022a35;">
                <div class="card-body">
...
##
        ...
        public function editComment($uid, $data, $key = null){
            ...
            return sn_response(array(
                ...
                "comment"   => $this->renderTheme("comment", array(new Comment($uid, $comment["page_uuid"]), $uid, $comment["depth"])),
                "referer"   => $referer
            ), $key);
        }
