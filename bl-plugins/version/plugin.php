...
class pluginVersion extends Plugin {
	...
	public function adminSidebar()
	{
		...
		if ($this->getValue('newVersionAlert')) {
			$html .= '<a id="new-version" style="display: none;" target="_blank" href="https://www.bludit.ir">'.$L->get('New version available').' <span class="fa fa-bell" style="color: red"></span></a>';
		}
		return $html;
	}
